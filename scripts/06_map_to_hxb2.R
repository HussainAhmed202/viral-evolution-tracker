...
# In the standard HXB2 (K03455) annotation: at 2358–5096, is pol — pol's CDS entry starts slightly later than 2085 because of a ribosomal frameshift region right at the start of pol that's awkward to represent as a simple CDS
...
hxb2_pol_nt <- pol_entry[1]   # still DNAString object
...
top_hotspots_mapped <- merge(top_hotspots_aa, mapping,
                             by.x = "codon_position", by.y = "our_position")
